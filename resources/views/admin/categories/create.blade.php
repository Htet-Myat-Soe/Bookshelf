...
<div class="container-fluid px-1 py-5 mx-auto">
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            ...
            @endif
            <div class="form_card">
                <form class="form-card" action="{{route('admin_categories.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row justify-content-end my-3">
                        <div class="form-group col-sm-6"> <button type="submit" class="btn-block btn-info">Create</button> </div>
                    </div>
                </form>
            </div>
        </div>
